...
//    }
    ...
    /**
     * Parses a playlist file (*.pls) provided as {@link BufferedReader}.
     *
     * @param reader PLS file {@link InputStream}
     * @return {@link Playlist} instance
     */
    public static Playlist parse(final BufferedReader reader) {
