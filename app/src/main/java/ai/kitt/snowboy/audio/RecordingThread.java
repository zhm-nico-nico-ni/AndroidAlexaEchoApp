...
public class RecordingThread {
    ...
    private ISnowEventCallback handler = null;
    ...
    public RecordingThread(ISnowEventCallback handler, AudioDataReceivedListener listener) {
...
//        }
        ...
        byte[] audioBuffer = new byte[SingleAudioRecord.getInstance().getBufferSizeInBytes()];
        ...
        while (shouldContinue) {
            SingleAudioRecord.getInstance().getAudioRecorder().read(audioBuffer, 0, audioBuffer.length);
