...
//        TODO 后续还要添加其他处理
    ...
    private void startNearTalkVoiceRecord(String path, final IMyVoiceRecordListener callback, final Initiator initiator, int waitMicTimeOut){
        ...
        try {
            myNearTalkVoiceRecord = new NearTalkVoiceRecord(endIndexInSamples, path ,NearTalkVoiceRecord.DEFAULT_SILENT_THRESHOLD, callback, needTips ? 1000 : waitMicTimeOut );
